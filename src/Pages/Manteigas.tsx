          ...
          >
            <AnimatedSection>
              <img
               ...
               hover:scale-105 transition duration-700 max-w-2xl "
                src={manteigas}
              ...
              >
                ...
                <AnimatedY>
                  <div className="flex-col items-center justify-center">
                    ...
                    <div>
                      <p className="text-custom-blue-strong text-justify mt-8">
                        Seja no café da manhã, no preparo de receitas ou para
                        dar aquele toque especial aos seus pratos, a Manteiga de
                        Primeira Qualidade com Sal traz o equilíbrio perfeito
                        entre cremosidade, sabor autêntico e frescor
                        incomparável. Feita a partir de leite puro e
                        selecionado, essa manteiga tem um toque de sal na medida
                        certa, realçando o sabor dos alimentos e garantindo uma
                        experiência única a cada mordida. <br />
                        <br /> ✅ Textura cremosa e fácil de espalhar. <br /> ✅
                        Sabor rico e autêntico, com toque de sal na medida.{" "}
                        <br /> ✅ Ideal para pães, torradas, receitas e
                        finalizações gourmet. <br /> ✅ Fonte natural de
                        vitaminas A e D.
                      </p>
                    </div>
                    <div className="max-md:w-full max-md:items-center max-md:justify-center">
    ...
    shadow-black font-light 
     ...
     shadow-black font-light 
      border-none mt-8 max-md:w-full cursor-pointer"
          ...
          {/*footer inicio */}
          <footer
            className="w-full h-auto mb-5 -mt-32
